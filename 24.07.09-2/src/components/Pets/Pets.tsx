...
const Pets = () => {
    ...
    return (
        <div className="pets-layout">
                        ...
                        // Wir benötigen in map immer ein einzigartigen key, da wird meistens der index verwendet (muss aber nicht)
                    
                        
                            <Pet key={index} emoji={item.emoji} name={item.name} species={item.species} habitat={item.habitat} lifespan={item.lifespan} diet={item.diet} funFacts={item.funFacts} />
